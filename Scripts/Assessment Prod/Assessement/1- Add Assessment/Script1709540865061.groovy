...
'Generated date: 02-Oct-2023 10:22:46 AM'
...
'click | css=.fa-plus:nth-child(1) |  | '
selenium.click('css=.fa-plus:nth-child(1)')
...
'click | css=.checkbox-inline:nth-child(1) > .ng-binding |  | '
selenium.click('css=.checkbox-inline:nth-child(1) > .ng-binding')
...
'click | css=.row:nth-child(1) > .col:nth-child(2) > .ng-binding |  | '
selenium.click('css=.row:nth-child(1) > .col:nth-child(2) > .ng-binding')
...
'click | css=.panel:nth-child(6) .radio:nth-child(1) > .ng-binding |  | '
selenium.click('css=.panel:nth-child(6) .radio:nth-child(1) > .ng-binding')
...
'click | css=.row:nth-child(2) > .col-xs-6:nth-child(1) > .staging |  | '
selenium.click('css=.row:nth-child(2) > .col-xs-6:nth-child(1) > .staging')
