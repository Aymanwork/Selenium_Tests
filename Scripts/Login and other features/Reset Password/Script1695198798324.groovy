...
'Generated date: 19-Sep-2023 10:12:57 AM'
'File path: C:\\Users\\Ayman\\Downloads\\Selenium Test Cases\\All test cases\\Login & Other Features.side'
...
"click | linkText=Need to restore password? |  | "
selenium.click("linkText=Need to restore password?")

"type | css=.has-error:nth-child(1) .form-control | Test | "
selenium.type("css=.has-error:nth-child(1) .form-control", "Test")

"type | name=email | test@gmail.com | "
selenium.type("name=email", "test@gmail.com")
