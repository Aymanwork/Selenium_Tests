...
"click | css=#menu-content > li:nth-child(9) |  | "
selenium.click("css=#menu-content > li:nth-child(9)")

"click | css=#settings > .ng-scope:nth-child(6) |  | "
selenium.click("css=#settings > .ng-scope:nth-child(6)")
