...
'Generated date: 02-Oct-2023 10:22:02 AM'
...
'click | css=.dropdown-btn:nth-child(2) |  | '
selenium.click('css=.dropdown-btn:nth-child(2)')

WebUI.delay(3)

'click | id=radio-wstatus-healed |  | '
selenium.click('id=radio-wstatus-healed')
...
'click | id=radio-wstatus-closed |  | '
selenium.click('id=radio-wstatus-closed')
...
'click | id=radio-wstatus-active |  | '
selenium.click('id=radio-wstatus-active')
